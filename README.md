...
of the source's skin texture. What claws it back by default is blending source pixels
...
alternative: head rotations move every pixel, so there is nothing unchanged to
restore from and sharpening is the only lever there (38% -> 68%).
